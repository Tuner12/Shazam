...
# for i in {0..4}; do
#   model=${MODELS[$i]}
#   echo "==== Launching model: $model on GPU $i ===="

#   if [ "$model" = "hoptimus0" ]; then
#     BATCH_SIZE=256
#   else
#     BATCH_SIZE=512
#   fi
...
#   FEAT_DIR="../survival_analysis/TCGA_KIRC_multi_features/${model}_features/part${CSV_INDEX}"
#   LOG_DIR="../survival_analysis/logs/KIRC"
#   CSV_PATH="../survival_analysis/TCGA_KIRC_PATCH_DIR40/process_list_autogen_part${CSV_INDEX}.csv"
...
#     --batch_size $BATCH_SIZE \
#     --slide_ext .svs \
#     > "$LOG_DIR/${model}_gpu10.txt" 2>&1 &
# done

# wait
# echo "==== All models on part ${CSV_INDEX} completed. ===="