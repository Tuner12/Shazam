...
# python multi_moe_distill_v2.py --csv dataset_csv/survival_by_case/TCGA_BLCA_Splits.csv --splits_dir splits82/TCGA_BLCA_survival_100 --root TCGA_BLCA_multi_features --teacher gigapath_features hoptimus1_features phikon_v2_features uni_v2_features virchow2_features --epochs 100 --lr 2e-4
# python multi_moe_distill_v2.py --csv dataset_csv/survival_by_case/TCGA_BLCA_Splits.csv --splits_dir splits82/TCGA_BLCA_survival_100 --root TCGA_BLCA_multi_features --teacher gigapath_features hoptimus1_features phikon_v2_features uni_v2_features virchow2_features --epochs 100 --lr 2e-4 > runBLCA.txt 2>&1
# python multi_moe_distill.py --csv dataset_csv/survival_by_case/TCGA_KIRC_Splits.csv --splits_dir splits82/TCGA_KIRC_survival_100 --root TCGA_KIRC_multi_features --teacher gigapath_features hoptimus1_features phikon_v2_features uni_v2_features virchow2_features --epochs 100 --lr 2e-4 > runKIRC.txt 2>&1